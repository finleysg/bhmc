...
import { SSEErrorEvent, SSEErrorEventSchema, SSEUpdateEvent, SSEUpdateEventSchema } from "../types/sse"
...
export function useRegistrationSSE({ eventId, enabled, onUpdate, onError }: UseRegistrationSSEOptions): void {
