...
export function ImportLeaderboardScreen() {
	...
	const { mutateAsync: uploadFile, status: uploadStatus, error: uploadError } = useEventDocumentSave(clubEvent.id)
	...
	const { mutateAsync: importLowScores, status: lowScoresStatus, error: lowScoresError } = useImportLowScores()
			...
			<div className="col-lg-4 col-md-6 col-sm-12">
				<CardContent contentKey="import-scores">
					<>
						...
						{uploadError && <ErrorDisplay error={uploadError.message} delay={5000} onClose={() => void 0} />}
					</>
				</CardContent>
			</div>
			<div className="col-lg-4 col-md-6 col-sm-12">
				...
				<>
					{pointsError && <ErrorDisplay error={pointsError.message} delay={5000} onClose={() => void 0} />}
					{scoresError && <ErrorDisplay error={scoresError.message} delay={5000} onClose={() => void 0} />}
					{lowScoresError && <ErrorDisplay error={lowScoresError.message} delay={5000} onClose={() => void 0} />}
				</>
