			...
			<div className="col-lg-4 col-md-6 col-sm-12">
				<CardContent contentKey="import-champs">
					<>
						...
						<UploadDataFileForm commandName="Import Champions" onSubmit={handleUpload} className="mb-2" />
						{uploadError && <ErrorDisplay error={uploadError.message} delay={5000} onClose={() => void 0} />}
						{importError && <ErrorDisplay error={importError.message} delay={15000} onClose={() => void 0} />}
					</>
				</CardContent>
			</div>
			<div className="col-lg-4 col-md-6 col-sm-12">
