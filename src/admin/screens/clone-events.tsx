		...
		<div className="row">
			<div className="col-lg-4 col-md-6 col-sm-12 offset-lg-4 offset-md-3">
				...
				<CardContent contentKey="copy-event">
					<>
						<SeasonSelect season={currentSeason - 1} startAt={startingYear} onSelect={handleSeasonSelect} />
						{events && <CopyEventHandler events={events} season={season} onComplete={handleCopyComplete} />}
						{newEvent && (
							<div>
								...
								<ul className="nav flex-column">
									...
									<li className="nav-item">
										<Link to={`https://api.bhmc.org/admin/events/event/${newEvent.id}/change/`} target="_blank">
											Event Settings
										</Link>
									</li>
								</ul>
