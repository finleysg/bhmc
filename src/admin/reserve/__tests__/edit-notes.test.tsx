...
test("renders correctly with initial notes", () => {
	...
	expect(screen.getByText("Add any special requests or notes for this player's registration.")).toBeInTheDocument()
})
...
test("has proper form structure and accessibility", () => {
	...
	expect(screen.getByText("Add any special requests or notes for this player's registration.")).toHaveAttribute(
		"id",
		"notes-help",
	)
