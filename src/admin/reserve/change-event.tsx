	...
	return (
		<div className="card border border-warning">
			<div className="card-body">
				...
				<EventSelector season={currentSeason} eventType={EventType.Major} onSelectEvent={handleSelect} />
				...
				<div className="card-footer d-flex justify-content-end pb-0">
					...
					<button disabled={!targetEvent} className="btn btn-warning btn-sm mt-2" onClick={handleSwap}>
						Confirm Change
					</button>
				</div>
			</div>
