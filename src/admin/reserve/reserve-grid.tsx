...
interface ReserveGridAdminProps extends Omit<ComponentPropsWithoutRef<"div">, "onDrop"> {
	clubEvent: ClubEvent
	table: ReserveTable
	onRegister: (slot: ReserveSlot, playerId: number, feeIds: number[], isMoneyOwed: boolean, notes: string) => void
	onMove: (registrationId: number, sourceSlots: ReserveSlot[], destinationSlots: ReserveSlot[]) => void
