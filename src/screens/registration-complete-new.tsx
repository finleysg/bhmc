...
export function RegistrationCompleteScreen() {
  ...
  const { completeRegistration, currentStep } = useEventRegistration()
  ...
  }, [stripe, completeRegistration, params])
                ...
                {intent?.status === "succeeded" && (
                  <>
                    <h5 className="text-primary-emphasis">
                      Your payment for {config.currencyFormatter.format(stripeAmount / 100)} has
                      been processed.
                    </h5>
                    <p>
