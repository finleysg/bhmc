					...
					<div className="card-body">
						...
						{blocker.state === "blocked" && (
							<div className="alert alert-danger mb-4">
								...
								<p className="mb-2">
									Your payment is currently being processed. Leaving this page now could result in an incomplete
									transaction or duplicate charges.
								</p>
								<p className="mb-3">
						...
						<div style={{ textAlign: "right" }}>
							...
							<button className="btn btn-secondary" disabled={paymentProcessing} onClick={handleBack}>
								Back
							</button>
