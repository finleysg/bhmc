				...
				<div className="card border border-primary mb-4">
					<div className="card-body">
						...
						<div className="mb-4">
							...
							<RegisteredPlayerSelector registration={currentRegistration} limit={1} onChange={handleSourceChange} />
						</div>
						<div className="mb-4">
						...
						<div style={{ textAlign: "right" }}>
							<button className="btn btn-secondary me-2" onClick={handleBack} disabled={isSubmitting}>
								Back
							</button>
							<button className="btn btn-primary" onClick={handleReplace} disabled={!canReplace || isSubmitting}>
								Replace
							</button>
						</div>
					</div>
