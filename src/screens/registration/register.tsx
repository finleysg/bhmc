		...
		<div className="row">
				...
				<div className="card border border-primary mb-4">
					<div className="card-body">
						...
						<div className="d-flex justify-content-between">
							...
							{showPickers && <FriendPickerPullout clubEvent={clubEvent} onSelect={handleFriendSelect} />}
						</div>
			...
			<div className="col-12 col-md-3">
				...
				<Dialog show={showPriorityDialog} title="Large Groups Only" onClose={handlePriorityCancel}>
					<p>
						During the priority registration period, you must have 3 to 5 players to register. Please wait until sign
						ups open for twosomes and singles.
					</p>
				</Dialog>
			</div>
		</div>
