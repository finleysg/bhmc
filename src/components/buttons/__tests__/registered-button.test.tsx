...
import { renderWithAuth, screen, setupAuthenticatedUser, verifyNeverOccurs, waitFor } from "../../../test/test-utils"
...
test.each([["priority"], ["registration"], ["past"]])(
	...
	async (registrationWindow) => {
		...
		await waitFor(() => expect(screen.queryByRole("link", { name: /players/i })).toBeInTheDocument())
	},
)
