	...
	return (
		<div className="payment-status-indicator mb-3">
			<div className="d-flex align-items-center">
				<span className={isProcessing ? "text-primary" : "text-muted"}>{step || "Ready to process payment"}</span>
				{isProcessing && elapsedTime > 0 && <span className="ms-2 text-muted small">({formatTime(elapsedTime)})</span>}
			</div>
					...
					<div className="d-flex justify-content-between align-items-start">
						<div>
							...
							<p className="mb-0 small">
								This can happen due to network issues or bank verification. Please wait a bit longer or try canceling
								and starting over.
							</p>
						</div>
