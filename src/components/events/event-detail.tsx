		...
		<div className="card mb-4">
			<div className="card-body">
				...
				<div className="card-text">
					{clubEvent.status === EventStatusType.Canceled ? <h4 className="text-danger">Canceled</h4> : null}
					<div className="registration-start-item">
						<div className="label">Event date:</div>
						<div className="value text-primary-emphasis fw-bold">{dayAndDateFormat(clubEvent.startDate)}</div>
					</div>
					<div className="registration-start-item">
