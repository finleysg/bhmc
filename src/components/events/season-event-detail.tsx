...
export function SeasonEventDetail({ clubEvent, onRegister }: Pick<EventDetailProps, "clubEvent" | "onRegister">) {
	...
	return (
		<div className="card">
			<AdminLinkButton to={clubEvent?.adminUrl} label="Event administration home" color={colors.teal} />
								...
								{!hasSignedUp && (
									<div className="col-12">
										...
										<p>
											...
											<Link to="/my-account">My Account</Link> page before you register for the {currentSeason} season.
										</p>
									</div>
								)}
								{hasSignedUp && (
