...
export function ProfilePhotoPicker({ onClose, onSelect }: ProfilePhotoPickerProps & CloseableProps) {
	...
	return (
		<div className="pmb-block">
			...
			<button className="btn btn-primary btn-sm me-2" onClick={() => onSelect(pic!)} disabled={!pic}>
				Save
			</button>
