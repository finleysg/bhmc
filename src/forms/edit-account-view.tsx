...
export function EditAccountView({ form, onCancel, onSubmit }: EditAccountViewProps) {
	...
	return (
		<form onSubmit={handleSubmit(submitForm)}>
			...
			/>
			<InputControl name="email" type="email" label="Email" register={register("email")} error={formErrors.email} />
			<InputControl name="ghin" type="text" label="GHIN" register={register("ghin")} error={formErrors.ghin} />
			<InputControl
				name="birth_date"
				type="date"
				label="Birthday"
			...
			<button type="reset" className="btn btn-light btn-sm" disabled={isSubmitting} onClick={onCancel}>
				Cancel
			</button>
